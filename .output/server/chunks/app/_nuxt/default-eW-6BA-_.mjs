...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AvatarImage = _sfc_main$f;
      const _component_Button = _sfc_main$k;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-898958db>`);
      ...
      _push(ssrRenderComponent(_component_Menubar, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row justify-between w-full" data-v-898958db${_scopeId}><div class="flex" data-v-898958db${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center pr-4" data-v-898958db${_scopeId}><div class="youtube-player" data-v-898958db${_scopeId}><div data-v-898958db${_scopeId}></div></div><div class="flex items-center" data-v-898958db${_scopeId}>`);
            if (unref(nowVideo)) {
            ...
            _push2(`<div class="cursor-pointer p-2" data-v-898958db${_scopeId}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-898958db"]]);
...
//# sourceMappingURL=default-eW-6BA-_.mjs.map
