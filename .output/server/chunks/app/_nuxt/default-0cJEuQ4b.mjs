...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Menubar, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (unref(nowVideo)) {
              _push2(`<div class="text-sm text-neutral-400"${_scopeId}>${ssrInterpolate((_a = unref(nowVideo)) == null ? void 0 : _a.title)} ${ssrInterpolate((_b = unref(nowVideo)) == null ? void 0 : _b.kr)} ${ssrInterpolate((_c = unref(nowVideo)) == null ? void 0 : _c.season)}\uAE30 ${ssrInterpolate((_d = unref(nowVideo)) == null ? void 0 : _d.cool)}\uCFE8 ${ssrInterpolate((_e = unref(nowVideo)) == null ? void 0 : _e.op_ed)}</div>`);
            } else {
              _push2(`<!---->`);
            }
      ...
      _push(`<div style="${ssrRenderStyle({ display: "none" })}"><div></div>`);
      _push(ssrRenderComponent(_component_Button, { onClick: play }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`play`);
          } else {
...
//# sourceMappingURL=default-0cJEuQ4b.mjs.map
