  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(books), (book) => {
        _push(`<li><img class="rounded-md h-72 w-full object-cover"${ssrRenderAttr(
          "src",
          book.link ? ("replaceDomain" in _ctx ? _ctx.replaceDomain : unref(replaceDomain))(book.link).replace(/co\.kr/g, "com") : ""
        )}><div>${ssrInterpolate(book.title)}</div><div class="flex text-xs text-neutral-400 gap-2"><div>`);
...
//# sourceMappingURL=board2-cqQIIpOf.mjs.map
