...
import { _ as _sfc_main$f, a as _sfc_main$1$2 } from './Card-rE7bkXeJ.mjs';
import { _ as _sfc_main$g } from './index-64ep_nG4.mjs';
import { u as useYouTube, n as nowTouTube, b as nextYouTube, p as prevYouTube } from './useYouTube-60Rd4hID.mjs';
import { useSSRContext, defineComponent, resolveComponent, mergeProps, withCtx, createTextVNode, createVNode, unref, toDisplayString, openBlock, createBlock, Fragment, renderList, ref, renderSlot, createCommentVNode } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSlot, ssrRenderAttrs, ssrRenderStyle } from 'vue/server-renderer';
import { _ as _sfc_main$i, a as _sfc_main$1$3 } from './Label-b9LsTsUK.mjs';
import { _ as _sfc_main$h } from './index-a6dO8h6t.mjs';
import { _ as _sfc_main$j } from './Input-eHzHGyo6.mjs';
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Label = _sfc_main$i;
      const _component_Input = _sfc_main$j;
      const _component_Textarea = _sfc_main$1$2;
      const _component_DialogFooter = _sfc_main$1$3;
      const _component_Button = _sfc_main$g;
      _push(ssrRenderComponent(_component_Dialog, mergeProps({
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_DialogYoutubeList = _sfc_main$d;
      ...
      const _component_font_awesome_icon = resolveComponent("font-awesome-icon");
      const _component_Button = _sfc_main$g;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-883cb79d>`);
      _push(ssrRenderComponent(_component_DialogYoutubeList, {
        open: unref(youtubeListOpen),
        "onUpdate:open": ($event) => youtubeListOpen.value = !unref(youtubeListOpen)
      }, null, _parent));
      ...
      _push(ssrRenderComponent(_component_Menubar, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row justify-between w-full" data-v-883cb79d${_scopeId}><div class="flex" data-v-883cb79d${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center pr-4" data-v-883cb79d${_scopeId}><div class="youtube-player" data-v-883cb79d${_scopeId}><div data-v-883cb79d${_scopeId}></div></div><div class="flex items-center" data-v-883cb79d${_scopeId}>`);
            if (unref(nowVideo)) {
              _push2(ssrRenderComponent(_component_Badge, {
                variant: "outline",
                class: "w-20 marquee cursor-pointer",
                onClick: ($event) => youtubeListOpen.value = true
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            _push2(`<div class="cursor-pointer p-2" data-v-883cb79d${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_MenubarMenu, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center space-x-2" data-v-883cb79d${_scopeId2}>`);
      ...
      _push(`<div style="${ssrRenderStyle(null)}" data-v-883cb79d></div></div>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-883cb79d"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/book/music" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Button, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/book/sale" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="mr-2 h-4 w-4"${_scopeId2}><rect width="7" height="7" x="3" y="3" rx="1"${_scopeId2}></rect><rect width="7" height="7" x="14" y="3" rx="1"${_scopeId2}></rect><rect width="7" height="7" x="14" y="14" rx="1"${_scopeId2}></rect><rect width="7" height="7" x="3" y="14" rx="1"${_scopeId2}></rect></svg> \uC74C\uC545 `);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-1 p-1 h-svh overflow-hidden" }, _attrs))}><div class="shrink-0">`);
...
//# sourceMappingURL=default-PQUWObff.mjs.map
