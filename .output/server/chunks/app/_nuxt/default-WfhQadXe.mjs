...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_font_awesome_icon = resolveComponent("font-awesome-icon");
      const _component_Button = _sfc_main$g;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-b265982e>`);
      ...
      _push(ssrRenderComponent(_component_Menubar, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row justify-between w-full" data-v-b265982e${_scopeId}><div class="flex" data-v-b265982e${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center pr-4" data-v-b265982e${_scopeId}><div class="youtube-player" data-v-b265982e${_scopeId}><div data-v-b265982e${_scopeId}></div></div><div class="flex items-center" data-v-b265982e${_scopeId}>`);
            if (unref(nowVideo)) {
            ...
            _push2(`<div class="cursor-pointer p-2" data-v-b265982e${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_MenubarMenu, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center space-x-2" data-v-b265982e${_scopeId2}>`);
      ...
      _push(`<div style="${ssrRenderStyle(null)}" data-v-b265982e></div></div>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b265982e"]]);
...
//# sourceMappingURL=default-WfhQadXe.mjs.map
