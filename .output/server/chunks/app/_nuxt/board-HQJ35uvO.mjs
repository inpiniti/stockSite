...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="md:p-2 md:py-4" data-v-af3a5909><div class="grid" data-v-af3a5909><div class="grid-sizer" data-v-af3a5909></div><!--[-->`);
      ssrRenderList(unref(pageBoards), (board2) => {
        _push(`<div class="w-screen mb-4 grid-item md:px-2 md:w-1/2 lg:w-1/3 xl:w-1/4 2xl:w-1/5 3xl:w-1/6 4xl:w-1/7" data-v-af3a5909><div class="relative w-full" data-v-af3a5909><div class="absolute z-10 p-2 text-white w-2/3" style="${ssrRenderStyle({ "pointer-events": "none" })}" data-v-af3a5909><div class="font-bold line-clamp-2" data-v-af3a5909>${ssrInterpolate(board2.title)}</div><div class="text-sm overflow-hidden whitespace-nowrap overflow-ellipsis" data-v-af3a5909>${ssrInterpolate(board2.writer)}</div></div>`);
                    ...
                    ssrRenderList(imgLinkParse(board2.link), (img, index) => {
                      _push3(ssrRenderComponent(_component_CarouselItem, { key: index }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="relative h-full" data-v-af3a5909${_scopeId3}><img class="md:rounded-md min-h-56 max-h-256 h-full w-full object-scale-down"${ssrRenderAttr("src", ("replaceDomain" in _ctx ? _ctx.replaceDomain : unref(replaceDomain))(img).replace(/co\.kr/g, "com"))} data-v-af3a5909${_scopeId3}>`);
        ...
        _push(`<div class="absolute top-0 left-0 w-full h-full md:rounded-md" style="${ssrRenderStyle({ "background": "linear-gradient(\n                to bottom,\n                rgba(0, 0, 0, 0.5),\n                rgba(0, 0, 0, 0) 50%,\n                rgba(0, 0, 0, 0) 50%,\n                rgba(0, 0, 0, 0.5)\n              )", "pointer-events": "none" })}" data-v-af3a5909></div><div class="p-4 flex w-full absolute bottom-0 text-white justify-between gap-4 items-end overflow-hidden" style="${ssrRenderStyle({ "pointer-events": "none" })}" data-v-af3a5909><div class="flex gap-4 items-end flex-1 overflow-hidden" data-v-af3a5909><img class="h-16 rounded-md object-cover shrink-0"${ssrRenderAttr("src", unref(KR_IMG_BOOKS)[board2.kr])} data-v-af3a5909><div class="flex-col flex-1 overflow-hidden" data-v-af3a5909><div class="line-clamp-2" data-v-af3a5909>${ssrInterpolate(board2.content)}</div><div class="flex text-xs gap-2" data-v-af3a5909><div class="font-normal" data-v-af3a5909>${ssrInterpolate(("timeAgo" in _ctx ? _ctx.timeAgo : unref(timeAgo))(board2.date))}</div></div></div></div><div class="flex flex-col gap-2 text-xl items-center shrink-0" data-v-af3a5909><div class="flex flex-col gap-1 items-center" style="${ssrRenderStyle({ "pointer-events": "auto" })}" data-v-af3a5909>`);
        _push(ssrRenderComponent(_component_font_awesome_icon, { icon: ["far", "comment"] }, null, _parent));
        _push(`<div class="text-sm" data-v-af3a5909>${ssrInterpolate(board2.number)}</div></div><div class="flex flex-col gap-1 items-center" data-v-af3a5909>`);
        _push(ssrRenderComponent(_component_font_awesome_icon, { icon: ["far", "eye"] }, null, _parent));
        _push(`<div class="text-sm" data-v-af3a5909>${ssrInterpolate(board2.count)}</div></div><div class="flex flex-col gap-1 items-center" data-v-af3a5909>`);
        _push(ssrRenderComponent(_component_font_awesome_icon, { icon: ["fas", "star"] }, null, _parent));
        _push(`<div class="text-sm" data-v-af3a5909>${ssrInterpolate(board2.recommend)}</div></div></div></div></div></div>`);
      });
      _push(`<!--]--></div><div class="w-full rounded-md p-2 flex items-center justify-center" data-v-af3a5909>`);
...
const board = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-af3a5909"]]);

export { board as default };
//# sourceMappingURL=board-HQJ35uvO.mjs.map
