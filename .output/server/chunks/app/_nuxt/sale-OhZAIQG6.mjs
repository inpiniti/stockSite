...
import { b as useBooks } from './useBooks-TTm7ObzJ.mjs';
import '../../user.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/sale.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=sale-OhZAIQG6.mjs.map
