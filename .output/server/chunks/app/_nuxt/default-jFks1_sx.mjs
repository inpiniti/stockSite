...
import { useSSRContext, defineComponent, ref, onUnmounted, mergeProps, unref, resolveComponent, withCtx, createVNode, createTextVNode, renderSlot, isRef, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode } from 'vue';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AvatarImage = _sfc_main$f;
      const _component_Button = _sfc_main$k;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0827872f>`);
      ...
      _push(ssrRenderComponent(_component_Menubar, { class: "lg:border-border border-0" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row justify-between w-full" data-v-0827872f${_scopeId}><div class="flex" data-v-0827872f${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center pr-4" data-v-0827872f${_scopeId}><div class="youtube-player" data-v-0827872f${_scopeId}><div data-v-0827872f${_scopeId}></div></div><div class="flex items-center" data-v-0827872f${_scopeId}>`);
            if (unref(nowVideo)) {
            ...
            _push2(`<div class="cursor-pointer p-2" data-v-0827872f${_scopeId}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-0827872f"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col lg:gap-1 lg:p-1 h-svh overflow-hidden" }, _attrs))}><div class="${ssrRenderClass([{ hidden: unref(isScrollingDown) }, "shrink-0"])}">`);
...
//# sourceMappingURL=default-jFks1_sx.mjs.map
