...
import { useForwardPropsEmits, DialogRoot, DialogTitle, DialogDescription, useEmitAsProps, DialogPortal, DialogOverlay, DialogContent, DialogClose } from 'radix-vue';
            ...
            _push2(ssrRenderComponent(unref(DialogContent), mergeProps({
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(DialogClose), { class: "absolute top-3 right-3 p-0.5 transition-colors rounded-md hover:bg-secondary" }, {
...
export { _sfc_main$4 as _, _sfc_main as a, _sfc_main$3 as b, _sfc_main$2 as c, _sfc_main$1 as d };
//# sourceMappingURL=DialogContent-clV1XwJL.mjs.map
