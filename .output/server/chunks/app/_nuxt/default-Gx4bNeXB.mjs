...
import { useSSRContext, defineComponent, resolveComponent, mergeProps, withCtx, createVNode, unref, createTextVNode, renderSlot, isRef, toDisplayString, openBlock, createBlock, Fragment, renderList, ref, createCommentVNode } from 'vue';
...
import { u as useYouTube, b as usePlayer, h as useYoutubePlayerRef, c as useNowYouTube, a as useYoutubeState, i as prev, p as play, d as pause, e as next } from './player-aO6P9NOG.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AvatarImage = _sfc_main$f;
      const _component_Button = _sfc_main$k;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-b091d2d1>`);
      ...
      _push(ssrRenderComponent(_component_Menubar, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row justify-between w-full" data-v-b091d2d1${_scopeId}><div class="flex" data-v-b091d2d1${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center pr-4" data-v-b091d2d1${_scopeId}><div class="youtube-player" data-v-b091d2d1${_scopeId}><div data-v-b091d2d1${_scopeId}></div></div><div class="flex items-center" data-v-b091d2d1${_scopeId}>`);
            if (unref(nowVideo)) {
            ...
            _push2(`<div class="cursor-pointer p-2" data-v-b091d2d1${_scopeId}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b091d2d1"]]);
...
//# sourceMappingURL=default-Gx4bNeXB.mjs.map
