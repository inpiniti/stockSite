...
function findBook(kr) {
  return useBooks().value.find((book) => book.kr === kr);
}
...
export { uniqueBooks as a, useBooks as b, fetchBooks as c, findBook as f, krImgBooks as k, namuKrBooks as n, useSelectedBook as u };
//# sourceMappingURL=useBooks-P5ZbZrgP.mjs.map
