...
import { DropdownMenuCheckboxItem, useEmitAsProps, DropdownMenuItemIndicator } from 'radix-vue';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full overflow-auto" }, _attrs))}><table class="${ssrRenderClass(unref(cn)("w-full caption-bottom text-sm", props.class))}">`);
...
export { _sfc_main$6 as _, _sfc_main$5 as a, _sfc_main$1 as b, _sfc_main as c, _sfc_main$2 as d, _sfc_main$4 as e, _sfc_main$3 as f };
//# sourceMappingURL=TableRow-1QbGuGr5.mjs.map
