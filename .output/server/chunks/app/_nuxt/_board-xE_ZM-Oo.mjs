...
import { k as krImgBooks } from './useBooks-7b4_Z3OE.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_masonry_wall, {
        ...
        default: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button data-v-60137cca${_scopeId}>test</button><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div><div data-v-60137cca${_scopeId}>${ssrInterpolate(item.kr)}</div>`);
          } else {
            return [
      ...
      _push(`<div class="w-full rounded-md p-2 flex items-center justify-center" data-v-60137cca>`);
...
const _board = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-60137cca"]]);

export { _board as default };
//# sourceMappingURL=_board-xE_ZM-Oo.mjs.map
