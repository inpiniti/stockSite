...
import { u as updateCoverImage, a as updateCoverImageFirst } from './useCoverList-kQSAeCJm.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function namuOpen(book2) {
      ...
      const { data } = await useFetch(`/api/namuWiki/${bookname}`, "$Y1tEXl443k");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/chart.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=chart-Xavpu2Sx.mjs.map
