import { _ as _sfc_main$1$1, a as _sfc_main$i } from './SheetContent-p1PlUTlZ.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-FXH7HDwx.mjs';
import { _ as _sfc_main$j } from './index-VljijB2M.mjs';
import { a as cn, d as useRoute } from '../server.mjs';
import { useSSRContext, defineComponent, ref, onUnmounted, mergeProps, unref, withCtx, renderSlot, createVNode, resolveComponent, createTextVNode, isRef, toDisplayString, openBlock, createBlock, Fragment, renderList } from 'vue';
...
import { _ as _sfc_main$4$1, a as _sfc_main$k, b as _sfc_main$3$1, c as _sfc_main$2$1, d as _sfc_main$1$2 } from './DialogContent-gH5cY4B6.mjs';
import { u as useSupabase } from './useSupabase-g_fbflW8.mjs';
import { cva } from 'class-variance-authority';
import { _ as _sfc_main$2$2, a as _sfc_main$l, b as _sfc_main$1$3 } from './TabsList-76hBfA3R.mjs';
import { MenubarItem, MenubarPortal, MenubarContent, MenubarMenu, MenubarRadioGroup, MenubarRadioItem, MenubarItemIndicator, MenubarSeparator, MenubarTrigger, AvatarRoot, AvatarImage, useForwardPropsEmits, SwitchRoot, SwitchThumb } from 'radix-vue';
import { _ as _sfc_main$m } from './Label-qeIRde0b.mjs';
import { useStorage } from '@vueuse/core';
import { u as useAuth } from './useAuth-Y16Mk0tA.mjs';
import moment from 'moment';
import { _ as _sfc_main$n } from './Card-AGwdWt8g.mjs';
import { u as useYouTube, b as usePlayer, h as useYoutubePlayerRef, c as useNowYouTube, a as useYoutubeState } from './player-QNo6EtRm.mjs';
import { _ as _sfc_main$r } from './DialogFooter-d_oHvfoT.mjs';
import { _ as _sfc_main$o } from './index-a6dO8h6t.mjs';
import { _ as _sfc_main$p } from './Input-eHzHGyo6.mjs';
import { _ as _sfc_main$q } from './Textarea-wJGe8b5L.mjs';
import { u as useFetch } from './fetch-ak_YyZbN.mjs';
import { _ as _sfc_main$s } from './Menubar-y4vSvdbp.mjs';
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SheetContent = _sfc_main$i;
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DialogContent = _sfc_main$k;
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DialogTitle = _sfc_main$2$1;
      const _component_DialogDescription = _sfc_main$1$2;
      const _component_Card = _sfc_main$n;
      const _component_Button = _sfc_main$j;
      const _component_font_awesome_icon = resolveComponent("font-awesome-icon");
      _push(ssrRenderComponent(_component_Dialog, mergeProps({
        open: _ctx.open,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DialogTitle = _sfc_main$2$1;
      const _component_DialogDescription = _sfc_main$1$2;
      const _component_Badge = _sfc_main$o;
      const _component_Label = _sfc_main$m;
      const _component_Input = _sfc_main$p;
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SheetSide = _sfc_main$a;
      const _component_DialogLogin = _sfc_main$9;
      const _component_DialogUser = _sfc_main$5;
      const _component_DialogYoutubeList = _sfc_main$4;
      const _component_DialogEmail = _sfc_main$3;
      const _component_Menubar = _sfc_main$s;
      const _component_MenubarMenu = _sfc_main$f;
      const _component_MenubarTrigger = _sfc_main$b;
      const _component_font_awesome_icon = resolveComponent("font-awesome-icon");
      const _component_MenubarContent = _sfc_main$g;
      const _component_MenubarRadioGroup = _sfc_main$e;
      const _component_MenubarRadioItem = _sfc_main$d;
      const _component_MenubarSeparator = _sfc_main$c;
      const _component_MenubarItem = _sfc_main$h;
      const _component_Avatar = _sfc_main$8;
      const _component_AvatarImage = _sfc_main$7;
      const _component_Button = _sfc_main$j;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white dark:bg-black" }, _attrs))} data-v-62f249ec>`);
      ...
      _push(ssrRenderComponent(_component_Menubar, { class: "border-0" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row justify-between w-full" data-v-62f249ec${_scopeId}><div class="flex" data-v-62f249ec${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center pr-4" data-v-62f249ec${_scopeId}><div class="youtube-player" data-v-62f249ec${_scopeId}><div data-v-62f249ec${_scopeId}></div></div>`);
            if (unref(auth)) {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-62f249ec"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function handleScroll() {
      const currentScrollPosition = (void 0).documentElement.scrollTop;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: scrollContainer
      }, _attrs))}><div class="${ssrRenderClass([{ hidden: unref(isScrollingDown) }, "sticky top-0 z-20"])}">`);
      _push(ssrRenderComponent(_component_LayoutsMenu, null, null, _parent));
      _push(`</div><div>`);
      _push(ssrRenderComponent(_component_LayoutsSide, { class: "shrink-0 hidden" }, null, _parent));
...
//# sourceMappingURL=default-IpphAvx6.mjs.map
