import { useSSRContext, defineComponent, mergeProps, withCtx, createVNode, createTextVNode, renderSlot, unref, computed, openBlock, createBlock, createCommentVNode, ref, isRef, resolveComponent, toDisplayString, Fragment, renderList, TransitionGroup, watch } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
...
import { _ as _sfc_main$k } from './book-7BGUHoYl.mjs';
import { _ as _sfc_main$i } from './index-VljijB2M.mjs';
import moment from 'moment';
import { _ as _sfc_main$j } from './index-a6dO8h6t.mjs';
import { u as useSelectedBook, b as useBooks } from './useBooks-TTm7ObzJ.mjs';
import { u as useBook } from './useBook-jIPfxSlK.mjs';
import { u as useBookInfoList } from './useBookInfoList-lxAGGPA0.mjs';
...
import { b as useCoverList } from './useCoverList-TFpT3_Hs.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!!_ctx.book) {
        ...
        _push(`</a><a${ssrRenderAttr("href", `https://namu.wiki/w/${_ctx.book.namu}`)} target="_blank" rel="noopener noreferrer">`);
        if (_ctx.book.namu) {
          _push(ssrRenderComponent(_component_Badge, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
        ...
        _push(`</a></div><div class="w-fit flex gap-2 items-center"> \uC800\uC790 `);
...
const usePaperback = () => useState("paperback", () => ({}));
  ...
  setup(__props) {
    ...
    const cCoverList = computed(() => {
      return coverList.value.filter((cover) => {
        ...
        return (_a = cover.kr) == null ? void 0 : _a.includes(selectedBook.value.kr);
      });
    });
    function handlePaperback(cover) {
              ...
              createVNode("div", { class: "flex-1 flex flex-col gap-2 p-2" }, [
                (openBlock(true), createBlock(Fragment, null, renderList(unref(cCoverList), (cover, index) => {
                  return openBlock(), createBlock("div", {
                    key: index,
                    onClick: ($event) => handlePaperback(cover)
                  }, [
                    createVNode("div", {
                      class: ["flex border rounded-lg p-2 gap-2 cursor-pointer hover:bg-neutral-50", { "bg-neutral-100": unref(selectedPaperback) == cover }]
                    }, [
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["click"],
  setup(__props, { emit: __emit }) {
    const selectBoard = useBoardDetail();
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b;
      const _component_Badge = _sfc_main$j;
      const _component_font_awesome_icon = resolveComponent("font-awesome-icon");
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["flex rounded-lg overflow-hidden hover:bg-neutral-100 hover:text-black gap-2 cursor-pointer border", { "bg-neutral-100": ((_a = unref(selectBoard)) == null ? void 0 : _a.id) == ((_b = _ctx.board) == null ? void 0 : _b.id) }]
      }, _attrs))}><div class="w-full p-4"><div class="flex gap-2"><div class="flex flex-col gap-2 grow-[0] w-full"><div class="flex gap-2 items-center text-sm">`);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function searchBooks() {
      ...
      if ((_a = selectedBook.value) == null ? void 0 : _a.kr) {
...
//# sourceMappingURL=mail-tZXM-TaY.mjs.map
