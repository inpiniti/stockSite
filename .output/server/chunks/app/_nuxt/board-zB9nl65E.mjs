  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(books), (book) => {
        _push(`<div class="w-screen"><div class="relative w-full"><div class="absolute z-10 p-2 text-white"><div class="font-bold">${ssrInterpolate(book.title)}</div><div class="text-sm">${ssrInterpolate(book.writer)}</div></div><img class="lg:rounded-md md:h-72 w-full h-fit object-cover"${ssrRenderAttr(
          "src",
...
//# sourceMappingURL=board-zB9nl65E.mjs.map
