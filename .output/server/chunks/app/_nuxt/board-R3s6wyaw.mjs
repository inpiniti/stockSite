import { _ as _sfc_main$b } from './style-DzneHoYd.mjs';
...
import { _ as _sfc_main$2$2, a as _sfc_main$d, b as _sfc_main$1$1 } from './PopoverContent-gqtQrpzl.mjs';
import { useSSRContext, ref, defineComponent, computed, useSlots, mergeProps, unref, isRef, createSlots, withCtx, createVNode, renderList, renderSlot, watch, resolveComponent, createTextVNode, toDisplayString, openBlock, createBlock, Fragment } from 'vue';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderStyle } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="${ssrRenderClass([{ hidden: unref(isScrollingDown) }, "fixed top-13 w-full z-20 border-y bg-white dark:bg-black"])}" data-v-0b991779>`);
                            ...
                            if (_push5) {
                              ...
                              ssrRenderList(unref(boards_kr), (book) => {
                                _push5(ssrRenderComponent(_component_SelectItem, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="flex items-center gap-2" data-v-0b991779${_scopeId5}><img class="h-8 rounded-md object-scale-down"${ssrRenderAttr("src", unref(KR_IMG_BOOKS)[book.kr])} data-v-0b991779${_scopeId5}><div data-v-0b991779${_scopeId5}>${ssrInterpolate(book.kr)}</div></div>`);
                                    } else {
                                      return [
                        ...
                        _push4(ssrRenderComponent(_component_Button, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<span data-v-0b991779${_scopeId4}>${ssrInterpolate(unref(date) ? unref(format)(unref(date), "yyyy-MM-dd") : "\uB0A0\uC9DC")}</span>`);
                            } else {
                              return [
      ...
      _push(`</div><div class="sm:hidden pt-10" data-v-0b991779><!--[-->`);
      ssrRenderList(unref(pageBoards), (board2) => {
        _push(`<div class="w-screen mb-4" data-v-0b991779><div class="relative w-full" data-v-0b991779><div class="absolute z-10 p-2 text-white w-2/3" style="${ssrRenderStyle({ "pointer-events": "none" })}" data-v-0b991779><div class="font-bold line-clamp-2" data-v-0b991779>${ssrInterpolate(board2.title)}</div><div class="text-sm overflow-hidden whitespace-nowrap overflow-ellipsis" data-v-0b991779>${ssrInterpolate(board2.writer)}</div></div>`);
                  ...
                  if (_push3) {
                    ...
                    ssrRenderList(imgLinkParse(board2.link), (img, index) => {
                      _push3(ssrRenderComponent(_component_CarouselItem, { key: index }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="relative h-full" data-v-0b991779${_scopeId3}><img class="md:rounded-md min-h-56 max-h-256 h-full w-full object-scale-down"${ssrRenderAttr("src", ("replaceDomain" in _ctx ? _ctx.replaceDomain : unref(replaceDomain))(img).replace(/co\.kr/g, "com"))} data-v-0b991779${_scopeId3}>`);
        ...
        _push(`<div class="absolute top-0 left-0 w-full h-full md:rounded-md" style="${ssrRenderStyle({ "background": "linear-gradient(\n              to bottom,\n              rgba(0, 0, 0, 0.5),\n              rgba(0, 0, 0, 0) 50%,\n              rgba(0, 0, 0, 0) 50%,\n              rgba(0, 0, 0, 0.5)\n            )", "pointer-events": "none" })}" data-v-0b991779></div><div class="p-4 flex w-full absolute bottom-0 text-white justify-between gap-4 items-end overflow-hidden" style="${ssrRenderStyle({ "pointer-events": "none" })}" data-v-0b991779><div class="flex gap-4 items-end flex-1 overflow-hidden" data-v-0b991779><img class="h-16 rounded-md object-cover shrink-0"${ssrRenderAttr("src", unref(KR_IMG_BOOKS)[board2.kr])} data-v-0b991779><div class="flex-col flex-1 overflow-hidden" data-v-0b991779><div class="line-clamp-2" data-v-0b991779>${ssrInterpolate(board2.content)}</div><div class="flex text-xs gap-2" data-v-0b991779><div class="font-normal" data-v-0b991779>${ssrInterpolate(("timeAgo" in _ctx ? _ctx.timeAgo : unref(timeAgo))(board2.date))}</div></div></div></div><div class="flex flex-col gap-2 text-xl items-center shrink-0" data-v-0b991779><div class="flex flex-col gap-1 items-center" style="${ssrRenderStyle({ "pointer-events": "auto" })}" data-v-0b991779>`);
        _push(ssrRenderComponent(_component_font_awesome_icon, { icon: ["far", "comment"] }, null, _parent));
        _push(`<div class="text-sm" data-v-0b991779>${ssrInterpolate(board2.number)}</div></div><div class="flex flex-col gap-1 items-center" data-v-0b991779>`);
        _push(ssrRenderComponent(_component_font_awesome_icon, { icon: ["far", "eye"] }, null, _parent));
        _push(`<div class="text-sm" data-v-0b991779>${ssrInterpolate(board2.count)}</div></div><div class="flex flex-col gap-1 items-center" data-v-0b991779>`);
        _push(ssrRenderComponent(_component_font_awesome_icon, { icon: ["fas", "star"] }, null, _parent));
        _push(`<div class="text-sm" data-v-0b991779>${ssrInterpolate(board2.recommend)}</div></div></div></div></div></div>`);
      });
      _push(`<!--]--><div class="w-full rounded-md p-2 flex items-center justify-center" data-v-0b991779>`);
      ...
      _push(`</div></div><div class="md:p-2 md:py-4 md:pt-14 hidden sm:block" data-v-0b991779><div class="grid" data-v-0b991779><div class="grid-sizer" data-v-0b991779></div><!--[-->`);
      ssrRenderList(unref(boards), (board2) => {
        _push(`<div class="w-screen mb-4 grid-item md:px-2 md:w-1/2 lg:w-1/3 xl:w-1/4 2xl:w-1/5 3xl:w-1/6 4xl:w-1/7" data-v-0b991779><div class="relative w-full" data-v-0b991779><div class="absolute z-10 p-2 text-white w-2/3" style="${ssrRenderStyle({ "pointer-events": "none" })}" data-v-0b991779><div class="font-bold line-clamp-2" data-v-0b991779>${ssrInterpolate(board2.title)}</div><div class="text-sm overflow-hidden whitespace-nowrap overflow-ellipsis" data-v-0b991779>${ssrInterpolate(board2.writer)}</div></div>`);
        _push(ssrRenderComponent(_component_Carousel, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_CarouselContent, null, {
...
const board = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0b991779"]]);

export { board as default };
//# sourceMappingURL=board-R3s6wyaw.mjs.map
