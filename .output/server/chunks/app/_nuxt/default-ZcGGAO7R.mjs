...
import { u as useRoute, a as cn } from '../server.mjs';
import { useSSRContext, defineComponent, ref, onUnmounted, mergeProps, unref, resolveComponent, withCtx, createVNode, createTextVNode, renderSlot, isRef, toDisplayString, openBlock, createBlock, Fragment, renderList } from 'vue';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AvatarImage = _sfc_main$f;
      const _component_Button = _sfc_main$k;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0cc85afb>`);
      ...
      _push(ssrRenderComponent(_component_Menubar, { class: "lg:border-border border-0 bg-white dark:bg-black" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row justify-between w-full" data-v-0cc85afb${_scopeId}><div class="flex" data-v-0cc85afb${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center pr-4" data-v-0cc85afb${_scopeId}><div class="youtube-player" data-v-0cc85afb${_scopeId}><div data-v-0cc85afb${_scopeId}></div></div>`);
            if (unref(auth)) {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-0cc85afb"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        hidden: unref(isScrollingDown),
        "translate-y-0 opacity-100": !unref(isScrollingDown),
        "-translate-y-full opacity-0": unref(isScrollingDown)
      }, "sticky top-0 z-20 transition-all duration-500 ease-in-out transform"])}">`);
...
//# sourceMappingURL=default-ZcGGAO7R.mjs.map
