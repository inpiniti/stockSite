import { useSSRContext, defineComponent, unref, withCtx, renderSlot, mergeProps, createVNode, ref, onUpdated, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderList } from 'vue/server-renderer';
import { DialogRoot, useEmitAsProps, DialogPortal, DialogOverlay, DialogContent, DialogClose, DialogTitle, DialogDescription, useForwardPropsEmits, SelectRoot, SelectValue, SelectTrigger, SelectIcon, SelectPortal, SelectContent, SelectViewport, SelectGroup, SelectItem, SelectItemIndicator, SelectItemText, SelectLabel } from 'radix-vue';
import { X, ChevronDown, Check } from 'lucide-vue-next';
import { cva } from 'class-variance-authority';
import { a as cn, b as useToast } from '../server.mjs';
import { _ as _sfc_main$2$1, a as _sfc_main$1$1, b as _sfc_main$f } from './PopoverContent-0dVJU1CB.mjs';
import { _ as _sfc_main$e } from './index-64ep_nG4.mjs';
import { _ as _sfc_main$g } from './Label-b9LsTsUK.mjs';
import { _ as _sfc_main$h } from './Input-eHzHGyo6.mjs';
import { u as useYouTube, a as addYouTube, s as searchVideos } from './useYouTube-kLfzHYRL.mjs';
import { u as useSupabase } from './useSupabase-m2hz1Dji.mjs';
import { _ as _sfc_main$5$1, a as _sfc_main$4$1, b as _sfc_main$3$1, c as _sfc_main$2$2, d as _sfc_main$1$2, e as _sfc_main$j } from './CardContent-V_9VJGoy.mjs';
import { _ as _sfc_main$i } from './Header-Ffs2ceUt.mjs';
import { u as uniqueBooks } from './useBooks-_FyEDEfB.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function clickThumbnail() {
      ...
      popoverData.value.thumbnail = result.value.items[0].snippet.thumbnails.high.url;
    }
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Sheet = _sfc_main$d;
      const _component_SheetContent = _sfc_main$c;
      const _component_SheetHeader = _sfc_main$b;
      const _component_SheetTitle = _sfc_main$a;
      ...
      const _component_PopoverContent = _sfc_main$f;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_Input, {
                                modelValue: unref(popoverData).thumbnail,
                                "onUpdate:modelValue": ($event) => unref(popoverData).thumbnail = $event,
                                id: "width",
                                type: "text",
                                class: "col-span-2 h-8"
                              }, null, _parent5, _scopeId4));
                              _push5(`<img${ssrRenderAttr("src", (_a = unref(popoverData)) == null ? void 0 : _a.thumbnail)}${_scopeId4}></div><div class="grid grid-cols-3 items-center gap-4"${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_Label, { for: "width" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`title`);
                                ...
                                createVNode("div", { class: "grid gap-4" }, [
                                  ...
                                  createVNode("div", { class: "grid gap-2" }, [
                                    createVNode("div", { class: "grid grid-cols-3 items-center gap-4" }, [
                                      ...
                                      createVNode("img", {
                                        src: (_b = unref(popoverData)) == null ? void 0 : _b.thumbnail
                                      }, null, 8, ["src"])
                                    ]),
                                    createVNode("div", { class: "grid grid-cols-3 items-center gap-4" }, [
                                      createVNode(_component_Label, { for: "width" }, {
                                ...
                                createVNode("div", { class: "grid gap-4" }, [
                                  ...
                                  createVNode("div", { class: "grid gap-2" }, [
                                    createVNode("div", { class: "grid grid-cols-3 items-center gap-4" }, [
                                      ...
                                      createVNode("img", {
                                        src: (_a = unref(popoverData)) == null ? void 0 : _a.thumbnail
                                      }, null, 8, ["src"])
                                    ]),
                                    createVNode("div", { class: "grid grid-cols-3 items-center gap-4" }, [
                                      createVNode(_component_Label, { for: "width" }, {
                  ...
                  ssrRenderList(unref(youtubeList), (video) => {
                    _push3(`<div${_scopeId2}><div class="flex gap-2"${_scopeId2}><img${ssrRenderAttr("src", video.thumbnail)} class="w-28 rounded-md"${_scopeId2}><div class="flex flex-col grow-[0]"${_scopeId2}><div class="text-sm font-bold text-clamp"${_scopeId2}>${ssrInterpolate(video.title)}</div><div class="text-xs"${_scopeId2}>${ssrInterpolate(video.kr)} ${ssrInterpolate(video.season)}\uAE30 ${ssrInterpolate(video.cool)}\uCFE8 ${ssrInterpolate(video.op_ed)}</div><div class="text-xs mt-1 px-2 py-1 rounded-md ring-1 ring-neutral-200 w-fit cursor-pointer"${_scopeId2}> \uC7AC\uC0DD\uBAA9\uB85D\uC5D0 \uCD94\uAC00 </div></div></div></div>`);
                  });
                  _push3(`<!--]--></div>`);
                } else {
                  return [
                        ...
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "flex gap-2" }, [
                            ...
                            createVNode("div", { class: "flex flex-col grow-[0]" }, [
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(video.kr) + " " + toDisplayString(video.season) + "\uAE30 " + toDisplayString(video.cool) + "\uCFE8 " + toDisplayString(video.op_ed), 1),
                              createVNode("div", {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DialogBoard = _sfc_main$5$1;
      const _component_CommonHeader = _sfc_main$i;
      const _component_Card = _sfc_main$4$1;
      const _component_CardHeader = _sfc_main$3$1;
      const _component_CardTitle = _sfc_main$2$2;
      const _component_CardDescription = _sfc_main$1$2;
      ...
      _push(`<div class="p-4" data-v-446828f3>`);
      _push(ssrRenderComponent(_component_CommonHeader, {
        title: "youtube",
        description: "\uC720\uD29C\uBE0C\uB97C \uC5F0\uB3D9\uD574\uC11C \uC74C\uC545\uC744 \uC7AC\uC0DD\uC2DC\uD0AC\uC218 \uC788\uC2B5\uB2C8\uB2E4."
      }, null, _parent));
      _push(`<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 pt-4" data-v-446828f3><!--[-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_CardContent, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", book.img)} data-v-446828f3${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: book.img
...
const youtube = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-446828f3"]]);

export { youtube as default };
//# sourceMappingURL=youtube-7b5AHAoL.mjs.map
