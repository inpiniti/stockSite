import { hasInjectionContext, getCurrentInstance, version, unref, inject, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, mergeProps, createApp, effectScope, reactive, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx } from 'vue';
...
const _routes = [
  {
    ...
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/_kr_-0LxN1rhx.mjs').then((m) => m.default || m)
      },
      {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/board-_U72CZqB.mjs').then((m) => m.default || m)
  },
  {
    name: "book-chart",
    path: "/book/chart",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/list-jeOlrUFl.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-9Q5qfgND.mjs').then((m) => m.default || m)
  },
  {
    name: "stock-columns",
    path: "/stock/columns",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/list-uAkgfzL3.mjs').then((m) => m.default || m)
  },
  {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-LW3__oG0.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
