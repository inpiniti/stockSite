...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/list-Gf7tT9A8.mjs').then((m) => m.default || m)
  },
  {
    name: "book-youtube",
    path: "/book/youtube",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/list-PerqZEN0.mjs').then((m) => m.default || m)
  },
  {
...
const layouts = {
  ...
  default: () => import('./_nuxt/default-0cJEuQ4b.mjs').then((m) => m.default || m)
};
