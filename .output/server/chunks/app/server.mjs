...
const _routes = [
  {
    ...
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/_kr_-o8PDUexT.mjs').then((m) => m.default || m)
      },
      {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/board-ybQKADwD.mjs').then((m) => m.default || m)
  },
  {
    name: "book-board3",
    path: "/book/board3",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/chart-Bp7ANYsZ.mjs').then((m) => m.default || m)
  },
  {
    name: "book-columns",
    path: "/book/columns",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/list-s-JZDI8l.mjs').then((m) => m.default || m)
  },
  {
    name: "book-music",
    path: "/book/music",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/music-sqwgo8gW.mjs').then((m) => m.default || m)
  },
  {
    name: "book-sale",
    path: "/book/sale",
